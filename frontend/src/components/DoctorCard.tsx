...
//                 <button
//                   onClick={handleContactClinic}
//                   className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-white text-[#0c213e] border border-[#0c213e] hover:bg-[#112a4d]/10 text-xs rounded-lg font-medium shadow-sm transition-all"
//                 >
...
//                 <button
//                   onClick={handleConsultClick}
//                   className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-[#0c213e] hover:bg-[#112a4d] text-white text-xs rounded-lg font-medium shadow-sm border border-[#0c213e] transition-all"
//                 >
